        ...
        for i in selector:
            for j in range(0, 25):
                if file == "{}P{}.JPG".format(i, j):
                    ...
                    im = cv.imread(r"fridayw7\{}".format(file), 0)  # add 0 if it is gray
                    ...
                    r = 20
                    new_array = temp1[xpos - r:xpos + r, ypos - r:ypos + r]  # red
                    # new_array = im[selected[0] - r:selected[0] + r, selected[1] - r:selected[1] + r] # gray
                    # print(new_array)
