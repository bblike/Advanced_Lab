...
import calculation7 as c7
import interactive as inte
#


path = r"C:\Users\{}\Desktop\Advanced_Lab\last_groups\middle_size".format(inte.name)
...
if __name__ == '__main__':
        ...
        for i in selector:
            for j in range(0, 30):
                if file == "{}P{}.JPG".format(i, j):
                    ...
                    im = cv.imread(r"C:\Users\{}\Desktop\Advanced_Lab\last_groups\middle_size\{}".format(inte.name, file), 0)
                    #print(np.shape(im))
    ...
    for temp in groups:
        ...
        a, b = c7.calculation(xval, yval, yerr, temp1[0][0])
    ...
    xs = np.array([108.7, 198.9, 304.85, 374.4, 460.3, 541.25, 618.65])
