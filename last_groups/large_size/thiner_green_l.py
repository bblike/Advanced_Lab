...
path = r"C:\Users\{}\Desktop\Advanced_Lab\last_groups\large_size".format(inte.name)
        ...
        for i in selector:
            for j in range(0, 30):
                if file == "{}P{}.JPG".format(i, j):
                    ...
                    im = cv.imread(r"C:\Users\{}}\Desktop\Advanced_Lab\last_groups\large_size\{}".format(inte.name, file), 0)
                    #print(np.shape(im))
